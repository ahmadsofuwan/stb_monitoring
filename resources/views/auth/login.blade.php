...
<head>
    ...
    <title>Sign In | STB Monitoring</title>
</head>
                                    ...
                                    <div class="form-body">
                                        <form class="row g-3" action="{{ route('login.post') }}" method="POST">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input type="text" name="username" class="form-control @error('username') is-invalid @enderror" id="inputUsername" placeholder="Username" value="{{ old('username') }}">
                                                @error('username')
